...
if (is_array($datos)) {
  ...
  if ($id > 0) {
    ...
    if ($productos != null) {
      ...
      $cuerpo .= '<h4>Puede ver los detalles de su pago en el siguiente enlace: <a href="http://localhost:8081/gestion_proyectos/ITutiShop/completado.php?key=' . $id_transaccion . '">Ver detalles del pago</a></h4>';
