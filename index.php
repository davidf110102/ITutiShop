...
$query = "SELECT id, slug, nombre, precio FROM productos WHERE activo = 1 $order";
            ...
            <div class="col mb-2">
              <form action="index.php" id="ordenForm" method="get">
                ...
                <select name="orden" id="orden" class="form-select form-select-sm" onchange="submitForm()">
                  ...
                  <option value="precio_alto" <?php echo ($orden === 'precio_alto') ? 'selected' : ''; ?>>Precios más
                    altos</option>
                  <option value="precio_bajo" <?php echo ($orden === 'precio_bajo') ? 'selected' : ''; ?>>Precios más
                    bajos</option>
